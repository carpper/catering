...
public class ForumController {
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(StringUtils.isNotBlank(forum.getContent())) {
            forum.setContent(SensitiveFilterUtil.filter(forum.getContent()));
        }
        if(StringUtils.isNotBlank(forum.getTitle())) {
            forum.setTitle(SensitiveFilterUtil.filter(forum.getTitle()));
        }
    	forum.setUserid((Long)request.getSession().getAttribute("userId"));
