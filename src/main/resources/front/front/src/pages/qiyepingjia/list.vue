		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.gangweileixing" placeholder="求职岗位" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">企业图片：</div>
				...
				<el-button class="list-add-btn" v-if="btnAuth('qiyepingjia','新增')" type="primary" @click="add('/index/qiyepingjiaAdd')">
			...
			<div class="list">
				...
				<div class="list2 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" class="list-item animation-box">
						...
						<div class="item-info">
							<div class="name">{{item.pingjiabianhao}}</div>
							<div class="name">{{item.qiuzhixingming}}</div>
							<div class="name">{{item.gangweileixing}}</div>
							<div class="name">{{item.pingjiashijian}}</div>
							<div class="time_item">
