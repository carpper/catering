<template>
	<div class="add-update-preview">
		<el-form
			...
			<!-- 面试方式选择 -->
			<el-form-item class="add-item" label="面试方式" prop="mianshixingshi">
				<el-select v-model="ruleForm.mianshixingshi" placeholder="请选择面试方式" :disabled="ro.mianshixingshi">
			...
			<!-- 面试地点/链接 -->
			<el-form-item class="add-item" label="面试地点/链接" prop="mianshididian">
				<el-input v-model="ruleForm.mianshididian" 
					placeholder="现场面试请填写地址，视频面试请填写链接" clearable :disabled="ro.mianshididian"></el-input>
			</el-form-item>
			<!-- 面试通知编辑 -->
			<el-form-item class="add-item" label="面试通知" prop="mianshitongzhi">
				<el-input type="textarea" :rows="4" v-model="ruleForm.mianshitongzhi" 
					placeholder="请输入面试通知内容，如：请携带简历、身份证等材料" clearable :disabled="ro.mianshitongzhi"></el-input>
			</el-form-item>
