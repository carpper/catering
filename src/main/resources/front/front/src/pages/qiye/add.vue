<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="主营范围" prop="zhuyingfanwei">
				<el-input v-model="ruleForm.zhuyingfanwei" 
					placeholder="主营范围" clearable :disabled=" false  ||ro.zhuyingfanwei"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="企业资质" prop="qiyezizhi">
				<file-upload
					tip="点击上传企业资质"
					action="file/upload"
					:limit="1"
