<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"4px 30px","margin":"10px 0","borderColor":"#d8dce5","background":"pink","borderWidth":"0 0 1px","display":"none","width":"100%","borderStyle":"solid","height":"34px"}'>
