	...
	<div class="menu-preview">
		...
		<el-scrollbar :wrap-class="isCollapse ? 'scrollbar-wrapper scrollbar-wrapper-close' : 'scrollbar-wrapper scrollbar-wrapper-open'">
			...
			<div class="title" :style="verticalStyle2[isCollapse?'close':'open'].title.box.default">
				...
				<span class="title-name" :style="verticalStyle2[isCollapse?'close':'open'].title.text.default">{{verticalStyle2[isCollapse?'close':'open'].title.text.showType?verticalStyle2[isCollapse?'close':'open'].title.text.text:''}} {{titleName}}</span>
			</div>
			<div class="userinfo"
	...
	computed: {
		titleName() {
			...
			if (sessionTable === 'qiye') {
				const qiyemingcheng = this.qiyemingcheng || this.$storage.get('qiyemingcheng');
				return qiyemingcheng ? qiyemingcheng + '招聘系统' : '企业招聘系统';
			}
			return this.$project.projectName || '餐饮人员招聘系统';
		},
		activeMenu() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'qiye') {
					...
					this.$storage.set('qiyemingcheng',data.data.qiyemingcheng)
					this.qiyemingcheng = data.data.qiyemingcheng
				}
