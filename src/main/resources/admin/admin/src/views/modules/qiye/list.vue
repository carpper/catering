<template>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						...
						label="主营范围">
						<template slot-scope="scope">
							{{scope.row.zhuyingfanwei}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' prop="qiyezizhi" label="企业资质">
						<template slot-scope="scope">
							<el-button v-if="scope.row.qiyezizhi" type="text" size="small" @click="download(scope.row.qiyezizhi)">下载</el-button>
							<span v-else >无</span>
						</template>
					</el-table-column>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpd		ate"></add-or-update>
